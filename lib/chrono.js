...
(function() {
  ...
  Chrono = (function() {
    ...
    */
    ...
    Chrono.prototype.reset = function(settings) {
      ...
      if (settings) {
        ...
        _ref = ['precision', 'startFrom', 'stopTo'];
      ...
      this.__time = this.__remainingTime = void 0;
      return this;
    };
    ...
    */
    ...
    Chrono.prototype.remainingTime = function(changes) {
      var remainingDuration;
      if (this.__remainingTime && !changes) {
        return this.__remainingTime;
      }
      if (!this.settings.stopTo) {
        return void 0;
      }
      remainingDuration = this.__newDate(this.settings.stopTo - this.__ms);
      if (changes) {
        remainingDuration = this.__applyDateChanges(remainingDuration, changes);
        this.settings.stopTo = remainingDuration.getTime();
      }
      return this.__timeObject(remainingDuration);
    };
    ...
    */
    ...
    Chrono.prototype.__tick = function() {
      ...
      if (this.settings.stopTo && this.__ms >= this.settings.stopTo) {
        this.__stop('end');
      } else {
    ...
    */
    ...
    Chrono.prototype.__stop = function(reason) {
      this.__timer.stop();
      this.ticking = false;
      this.__callHandlers(reason);
      return this;
    };
